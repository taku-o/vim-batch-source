:if &cp || exists("g:loaded_batch_source")
    :finish
:endif
:let g:loaded_batch_source = 1
...
==============================================================================
batch-source.vim : execute vim script in selected area.
------------------------------------------------------------------------------
$VIMRUNTIMEPATH/plugin/batch-source.vim
==============================================================================
author  : OMI TAKU
url     : http://nanasi.jp/
email   : mail@nanasi.jp
version : 2011/05/16 14:00:00
==============================================================================
...
1. Copy the batch-source.vim script to
